...
//		int count = string.length() - string.replace(search, '').length();
//		int count = string.replaceAll(Character.toString(search), "").length();
//		long countjava8 = string.chars().filter(search -> search == '.').count();
//		int countjava8 = new StringTokenizer(" " + string + " ", search).countTokens() - 1;
		int count = 0;
	...
	public static String replaceChar(String string, char search, char replace) {
		String newString = string.replaceAll(Character.toString(search), Character.toString(replace));
		return newString;
	}
	...
	public static String replaceString(String string, String search, String replace) {
		String newString = string.replaceAll(search, replace);
		return newString;
	}
